...
[^2]: This is an estimate of the number of SAM cases in a service delivery unit at the time of the survey: $\left \lfloor {Population_{\text{all ages}} \times \frac{\text{Percentage of population}_{\text{6-59 months}}}{100} \times \frac{\text{Prevalence SAM}}{100}} \right \rfloor$